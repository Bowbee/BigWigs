...
L.bossStagesTimerDesc = "首领战进入新阶段时计时器重置，仅对多阶段首领生效，鼠标悬停可查看首领战阶段历史。"
L.bossStagesTimerTooltip = "|TInterface\\AddOns\\BigWigs\\Media\\Icons\\minimap_raid:0:0|t首领战阶段历史"
...
L.slugRenderingDesc = "字体使用 Slug 库进行渲染。这有时可以使大字号字体看起来更清晰，但可能会改变描边的大小。|cFF33FF99详情请访问sluglibrary.com 。|r"
